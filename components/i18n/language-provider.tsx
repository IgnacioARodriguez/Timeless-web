...
export const copy = {
  es: {
    ...
    demoTitle: "Abrí una experiencia 180° ahora.",
    demoText:
    ...
    permissionsTitle: "Aceptá los permisos para iniciar la experiencia de cámara y movimiento",
    requesting: "Solicitando...",
    acceptPermissions: "Aceptar permisos e iniciar",
    cameraRequiredError: "El acceso a la cámara es necesario para la calibración. Permití el acceso desde la configuración del navegador e intentalo de nuevo.",
    ...
    cameraAccessError: "No se pudo acceder a la cámara. Permití el acceso e intentalo de nuevo.",
    somethingWrong: "Algo salió mal",
    unableContinue: "No se pudo continuar",
    tryAgain: "Intentar de nuevo",
    unexpectedError: "Ocurrió un error inesperado.",
    preparingExperience: "Preparando experiencia",
    playbackError: "Error de reproducción",
    retry: "Reintentar",
    videoLoadError: "No se pudo cargar el video de la experiencia.",
    imageLoadError: "No se pudo cargar la imagen panorámica.",
    ...
    help: "Ayuda",
    helpGyro: "Girá el móvil para mirar alrededor. También podés arrastrar con el dedo para ajustar la vista.",
    helpDrag: "Arrastrá con el dedo para mirar alrededor de la escena.",
