...
export const copy = {
  es: {
    ...
    permissionsRequired: "Al comenzar se solicitará acceso a cámara y movimiento",
  ...
  en: {
    ...
    permissionsRequired: "Camera and motion access will be requested when you start",
